...
contract GovernorCharlie is Ownable, IGovernor {
     ...
     * @param newOwner Address of new timelock owner.
     */
    function attemptRescue(address newOwner) external override {
        require(
        ...
        data[0] = abi.encodePacked(newOwner);
     ...
     * @param newOwner Address of new timelock owner.
     */
    function queueRescue(address newOwner) external override {
     ...
     * @param newOwner Address of new timelock owner.
     */
    function executeRescue(address newOwner) external override {
        Proposal storage proposal = proposals[rescueProposalId];
